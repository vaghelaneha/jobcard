...
<head>
    <meta charset="UTF-8">
    <title>new jon card creation P4</title>
    <style type="text/css">
        .error{ color: red; }
        .success{ color: green; }
    </style>
</head>
<body style="background-color:#dcd6bc;"><center>
    <h2 style="background-color: #766a3d;">NEW JOB CARD CREATION-P4</h2>
